...
// 1.ölkə adına görə descending sıra ilə düzün
// let sortedByName=countries_data.sort((a,b)=>b.name.localeCompare(a.name));
// console.log(sortedByName);


// 2.area görə ilk 10 ölkə
// let topTenArea=countries_data.sort((a,b)=>b.area-a.area).slice(0,10)
// console.log(topTenArea);

// 3.populationa gore ilk 10 ölkə
// let topTenPopulation=countries_data.sort((a,b)=>b.population-a.population ).slice(0,10)
// console.log(topTenPopulation);

// 4.ingilis dilli ölkeleri
// let englishLanguages=countries_data.filter(el=>el.languages.includes("English"))
// console.log(englishLanguages);

// 5.region asia ve europe olanlar
// const foundRegion=countries_data.filter((item) => item.region==="Asia" || item.region==="Europa")
// console.log(foundRegion);

// 6.birdən çox əsas dili olan ölkələr
let nameArray=countries_data.filter((a)=>a.languages.length>1)
console.log(nameArray);

// 7.bütün ölkə adlari ve qarsisinda paytaxtı

// 8.dünya əhalisinin sayı